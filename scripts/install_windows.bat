...
call mamba install -y numpy==1.19.0 scikit-image python-blosc==1.7.0
call mamba install -y pytorch==1.7.1 -c pytorch
call mamba install -y torchvision -c pytorch
call mamba install -y -c anaconda git
